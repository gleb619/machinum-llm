...
public class LineController {
    ...
    public List<Line> getLinesByBookId(@PathVariable String bookId) {
    ...
    public List<Line> findSimilarForBook(@PathVariable String bookId, @RequestBody FindSimilarRequest request) {
    ...
    public List<Line> findSimilarForChapter(@PathVariable String chapterId, @RequestBody FindSimilarRequest request) {
    ...
    public List<Line> getLinesByChapterId(@PathVariable String chapterId) {
    ...
    public ResponseEntity<Void> removeLine(@PathVariable String lineId, @RequestBody RemoveLineRequest request) {
