function listApp() {
    return {
        ...
        init() {
            this.currentContent = this.chapterInfo[this.selectedField];
        ...
        selectField(field) {
            ...
            this.currentContent = this.chapterInfo[field];
        ...
        saveChanges() {
            ...
            this.history.push(this.currentContent);
            this.chapterInfo[this.selectedField] = this.currentContent;
